...
1. [Gestores de dependencias](20150523_dependencias):
  ...
  * Composer.
  * Maven.
1. Lenguajes dinámicos y [REPL](http://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop):
  * Python + iPython.
  * Ruby + irb.
...
1. Entornos de desarrollo III:
  * Vagrant + Chef.
1. [IaaS](http://es.wikipedia.org/wiki/Computaci%C3%B3n_en_la_nube#Infraestructura_como_servicio):
  * Amazon.
  * DigitalOcean.
  * Rackspace.
  * Azure.
...
1. Dashboards con métricas:
  ...
  * Grafana.
  * Ducksboard.
1. [SaaS](http://es.wikipedia.org/wiki/Computaci%C3%B3n_en_la_nube#Software_como_servicio) de monitorización y métricas:
  * NewRelic.
  * DataDog.
  * Otros.
1. Cache:
